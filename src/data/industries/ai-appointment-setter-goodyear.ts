...
const data: TemplatePageData = {
  slug: "ai-appointment-setter-goodyear",
  breadcrumbName: "AI Appointment Setter in Goodyear",
  seo: {
    title: "AI Appointment Setter in Goodyear, AZ | Viking Marketing",
    description:
      "Viking's AI appointment setter answers every lead in Goodyear, qualifies them, and books the job. Built and run from Chandler, Arizona. Free demo.",
    ogImage: "/images/6a39996d28e2dab9ea4a-b5fad78c0323.webp",
    keywords: ["AI appointment setter Goodyear", "ai sales assistant Goodyear"],
  },
  schema: {
    kinds: ["localBusiness", "service", "webPage", "howTo", "faq"],
    serviceName: "AI Appointment Setter in Goodyear",
    serviceDescription:
      "Viking's AI appointment setter answers every lead that reaches a Goodyear business in seconds, qualifies them, and books the appointment, day or night.",
    areaServed: ["Goodyear", "Phoenix", "Chandler"],
    howTo: {
      name: "How the AI Appointment Setter Works",
      description:
        "Connect your business, we train the AI on your services and booking rules, and every lead gets answered and booked straight to your calendar. Most Goodyear-area businesses are live within 48 hours.",
    },
  },
  hero: {
    badge: "⚡ Built in Chandler · Serving local businesses across Goodyear",
    h1: "AI Appointment Setter in Goodyear",
    lede: "Your next customer just messaged. Whoever answers first books the job. Viking's AI appointment setter in Goodyear answers every lead in seconds, qualifies them, and books the appointment, day or night, so your competitor never gets the chance.",
  ...
  sections: [
    ...
    {
      type: "split",
      title: "Why Goodyear Businesses Need This Now",
      paragraphs: [
        "Goodyear is about 30 miles, a 40-minute drive from Viking's Chandler headquarters. Goodyear is one of the fastest-growing cities in the west valley, with substantial new residential development driving strong, ongoing demand for home services, dental and healthcare practices, and gyms serving newly-arrived homeowners.",
        "Whether you run a home-services contractor, a dental practice, or a gym, the pattern is the same: whoever replies first, and sounds like they know what they're doing, gets the appointment. A slow reply doesn't lose the customer to a better competitor, it loses them to whoever simply answered faster.",
        "Viking is built here, run from Chandler, and built specifically for this kind of business. We are not a national platform with a Goodyear landing page bolted on. Charlie, our founder, spent over a decade running local businesses in this market before he built Viking, so the problem this solves is one he lived through himself.",
      ],
      image: "/images/6a399b0e9aae5140d0b7-143ffbabda68.webp",
      imageAlt: "Map of the Phoenix metro showing AI appointment setter responding to leads near Goodyear",
      side: "left",
    },
    {
      type: "iconSteps",
      ...
      outro: "Most Goodyear-area businesses are live within 48 hours.",
    },
    {
      type: "compare",
      title: "AI Appointment Setter Cost vs. Hiring in Goodyear",
  ...
  faqContextLabel: "AI Appointment Setter in Goodyear",
  faqs: [
    {
    ...
    {
      q: "How does Viking's AI appointment setter work in Goodyear specifically?",
      a: "Every Goodyear client works directly with Viking's Chandler-based team for setup, not an outsourced call center. Your team reviews the AI's responses, business hours, and booking rules with a real person before it goes live, and most businesses are fully set up within 48 hours.",
    },
    {
      q: "Does it work for a business serving a lot of new residents?",
      a: "Yes. New residents are actively comparison-shopping for every local service they need, and the AI's under-60-second response time is specifically what wins that first booking before a competitor replies.",
    },
    {
    ...
    },
    {
      ...
      a: "Viking's plans start at $297 a month, flat, with no contracts and no per-seat fees. Compare that to a single front-desk hire in the Goodyear market, which runs well over $2,000 a month before benefits, and the AI pays for itself well before the end of the first month for most businesses.",
    },
    {
