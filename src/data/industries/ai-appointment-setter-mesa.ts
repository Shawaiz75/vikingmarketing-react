...
const data: TemplatePageData = {
  slug: "ai-appointment-setter-mesa",
  breadcrumbName: "AI Appointment Setter in Mesa",
  seo: {
    title: "AI Appointment Setter in Mesa, AZ | Viking Marketing",
    description:
      "Viking's AI appointment setter answers every lead in Mesa, qualifies them, and books the job. Built and run from Chandler, Arizona. Free demo.",
    ogImage: "/images/6a39996d28e2dab9ea4a-b5fad78c0323.webp",
    keywords: ["AI appointment setter Mesa", "ai sales assistant Mesa"],
  },
  schema: {
    kinds: ["localBusiness", "service", "webPage", "howTo", "faq"],
    serviceName: "AI Appointment Setter in Mesa",
    serviceDescription:
      "Viking's AI appointment setter answers every lead that reaches a Mesa business in seconds, qualifies them, and books the appointment, day or night.",
    areaServed: ["Mesa", "Phoenix", "Chandler"],
    howTo: {
      name: "How the AI Appointment Setter Works",
      description:
        "Connect your business, we train the AI on your services and booking rules, and every lead gets answered and booked straight to your calendar. Most Mesa-area businesses are live within 48 hours.",
    },
  },
  hero: {
    badge: "⚡ Built in Chandler · Serving local businesses across Mesa",
    h1: "AI Appointment Setter in Mesa",
    lede: "Your next customer just messaged. Whoever answers first books the job. Viking's AI appointment setter in Mesa answers every lead in seconds, qualifies them, and books the appointment, day or night, so your competitor never gets the chance.",
  ...
  sections: [
    ...
    {
      type: "split",
      title: "Why Mesa Businesses Need This Now",
      paragraphs: [
        "Mesa is about 10 miles, a 15-minute drive from Viking's Chandler headquarters. Mesa is one of the largest cities in the Phoenix metro by population, with a broad residential base that drives steady, year-round demand for home services, dental and healthcare practices, and family-oriented gyms and studios.",
        "Whether you run an HVAC or plumbing contractor, a dental practice, or a family gym, the pattern is the same: whoever replies first, and sounds like they know what they're doing, gets the appointment. A slow reply doesn't lose the customer to a better competitor, it loses them to whoever simply answered faster.",
        "Viking is built here, run from Chandler, and built specifically for this kind of business. We are not a national platform with a Mesa landing page bolted on. Charlie, our founder, spent over a decade running local businesses in this market before he built Viking, so the problem this solves is one he lived through himself.",
      ],
      image: "/images/6a399b0e9aae5140d0b7-143ffbabda68.webp",
      imageAlt: "Map of the Phoenix metro showing AI appointment setter responding to leads near Mesa",
      side: "left",
    },
    {
      type: "iconSteps",
      ...
      outro: "Most Mesa-area businesses are live within 48 hours.",
    },
    {
      type: "compare",
      title: "AI Appointment Setter Cost vs. Hiring in Mesa",
  ...
  faqContextLabel: "AI Appointment Setter in Mesa",
  faqs: [
    {
    ...
    {
      q: "How does Viking's AI appointment setter work in Mesa specifically?",
      a: "Every Mesa client works directly with Viking's Chandler-based team for setup, not an outsourced call center. Your team reviews the AI's responses, business hours, and booking rules with a real person before it goes live, and most businesses are fully set up within 48 hours.",
    },
    {
      q: "Can it handle a high volume of leads across a large residential service area?",
      a: "Yes. The AI replies to every lead at once, which matters in a city Mesa's size where a single front-desk person or answering service can't realistically keep up with volume during peak seasons.",
    },
    {
    ...
    },
    {
      ...
      a: "Viking's plans start at $297 a month, flat, with no contracts and no per-seat fees. Compare that to a single front-desk hire in the Mesa market, which runs well over $2,000 a month before benefits, and the AI pays for itself well before the end of the first month for most businesses.",
    },
    {
