...
const data: TemplatePageData = {
  slug: "ai-appointment-setter-peoria",
  breadcrumbName: "AI Appointment Setter in Peoria",
  seo: {
    title: "AI Appointment Setter in Peoria, AZ | Viking Marketing",
    description:
      "Viking's AI appointment setter answers every lead in Peoria, qualifies them, and books the job. Built and run from Chandler, Arizona. Free demo.",
    ogImage: "/images/6a39996d28e2dab9ea4a-b5fad78c0323.webp",
    keywords: ["AI appointment setter Peoria", "ai sales assistant Peoria"],
  },
  schema: {
    kinds: ["localBusiness", "service", "webPage", "howTo", "faq"],
    serviceName: "AI Appointment Setter in Peoria",
    serviceDescription:
      "Viking's AI appointment setter answers every lead that reaches a Peoria business in seconds, qualifies them, and books the appointment, day or night.",
    areaServed: ["Peoria", "Phoenix", "Chandler"],
    howTo: {
      name: "How the AI Appointment Setter Works",
      description:
        "Connect your business, we train the AI on your services and booking rules, and every lead gets answered and booked straight to your calendar. Most Peoria-area businesses are live within 48 hours.",
    },
  },
  hero: {
    badge: "⚡ Built in Chandler · Serving local businesses across Peoria",
    h1: "AI Appointment Setter in Peoria",
    lede: "Your next customer just messaged. Whoever answers first books the job. Viking's AI appointment setter in Peoria answers every lead in seconds, qualifies them, and books the appointment, day or night, so your competitor never gets the chance.",
  ...
  sections: [
    ...
    {
      type: "split",
      title: "Why Peoria Businesses Need This Now",
      paragraphs: [
        "Peoria is about 30 miles, a 40-minute drive from Viking's Chandler headquarters. Peoria has grown quickly as a northwest-valley suburb, with a mix of young families and an active spring-training and recreation economy, driving demand across home services, dental and healthcare practices, and fitness businesses.",
        ...
        "Viking is built here, run from Chandler, and built specifically for this kind of business. We are not a national platform with a Peoria landing page bolted on. Charlie, our founder, spent over a decade running local businesses in this market before he built Viking, so the problem this solves is one he lived through himself.",
      ],
      image: "/images/6a399b0e9aae5140d0b7-143ffbabda68.webp",
      imageAlt: "Map of the Phoenix metro showing AI appointment setter responding to leads near Peoria",
      side: "left",
    },
    {
      type: "iconSteps",
      ...
      outro: "Most Peoria-area businesses are live within 48 hours.",
    },
    {
      type: "compare",
      title: "AI Appointment Setter Cost vs. Hiring in Peoria",
  ...
  faqContextLabel: "AI Appointment Setter in Peoria",
  faqs: [
    {
    ...
    {
      q: "How does Viking's AI appointment setter work in Peoria specifically?",
      a: "Every Peoria client works directly with Viking's Chandler-based team for setup, not an outsourced call center. Your team reviews the AI's responses, business hours, and booking rules with a real person before it goes live, and most businesses are fully set up within 48 hours.",
    },
    {
      q: "Is Viking still responsive for a business this far from Chandler?",
      a: "Yes. Distance doesn't affect response time, the AI answers every lead in under 60 seconds regardless of where in the Valley your business is located, and setup and support happen remotely, the same way for every Viking client.",
    },
    {
    ...
    },
    {
      ...
      a: "Viking's plans start at $297 a month, flat, with no contracts and no per-seat fees. Compare that to a single front-desk hire in the Peoria market, which runs well over $2,000 a month before benefits, and the AI pays for itself well before the end of the first month for most businesses.",
    },
    {
