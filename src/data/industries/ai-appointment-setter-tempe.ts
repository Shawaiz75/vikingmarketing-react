...
const data: TemplatePageData = {
  slug: "ai-appointment-setter-tempe",
  breadcrumbName: "AI Appointment Setter in Tempe",
  seo: {
    title: "AI Appointment Setter in Tempe, AZ | Viking Marketing",
    description:
      "Viking's AI appointment setter answers every lead in Tempe, qualifies them, and books the job. Built and run from Chandler, Arizona. Free demo.",
    ogImage: "/images/6a39996d28e2dab9ea4a-b5fad78c0323.webp",
    keywords: ["AI appointment setter Tempe", "ai sales assistant Tempe"],
  },
  schema: {
    kinds: ["localBusiness", "service", "webPage", "howTo", "faq"],
    serviceName: "AI Appointment Setter in Tempe",
    serviceDescription:
      "Viking's AI appointment setter answers every lead that reaches a Tempe business in seconds, qualifies them, and books the appointment, day or night.",
    areaServed: ["Tempe", "Phoenix", "Chandler"],
    howTo: {
      name: "How the AI Appointment Setter Works",
      description:
        "Connect your business, we train the AI on your services and booking rules, and every lead gets answered and booked straight to your calendar. Most Tempe-area businesses are live within 48 hours.",
    },
  },
  hero: {
    badge: "⚡ Built in Chandler · Serving local businesses across Tempe",
    h1: "AI Appointment Setter in Tempe",
    lede: "Your next customer just messaged. Whoever answers first books the job. Viking's AI appointment setter in Tempe answers every lead in seconds, qualifies them, and books the appointment, day or night, so your competitor never gets the chance.",
  ...
  sections: [
    ...
    {
      type: "split",
      title: "Why Tempe Businesses Need This Now",
      paragraphs: [
        "Tempe is about 9 miles, a 15-minute drive from Viking's Chandler headquarters. Tempe runs on Arizona State University's population, which means dense, fast-turnover demand for dining, fitness studios, salons, and rental-property services, alongside a younger customer base that expects to text a business, not call it.",
        "Whether you run a fitness studio, a salon, or a property-management company, the pattern is the same: whoever replies first, and sounds like they know what they're doing, gets the appointment. A slow reply doesn't lose the customer to a better competitor, it loses them to whoever simply answered faster.",
        "Viking is built here, run from Chandler, and built specifically for this kind of business. We are not a national platform with a Tempe landing page bolted on. Charlie, our founder, spent over a decade running local businesses in this market before he built Viking, so the problem this solves is one he lived through himself.",
      ],
      image: "/images/6a399b0e9aae5140d0b7-143ffbabda68.webp",
      imageAlt: "Map of the Phoenix metro showing AI appointment setter responding to leads near Tempe",
      side: "left",
    },
    {
      type: "iconSteps",
      ...
      outro: "Most Tempe-area businesses are live within 48 hours.",
    },
    {
      type: "compare",
      title: "AI Appointment Setter Cost vs. Hiring in Tempe",
  ...
  faqContextLabel: "AI Appointment Setter in Tempe",
  faqs: [
    {
    ...
    {
      q: "How does Viking's AI appointment setter work in Tempe specifically?",
      a: "Every Tempe client works directly with Viking's Chandler-based team for setup, not an outsourced call center. Your team reviews the AI's responses, business hours, and booking rules with a real person before it goes live, and most businesses are fully set up within 48 hours.",
    },
    {
      q: "Does the AI work well with a younger, text-first customer base?",
      a: "Yes. Viking's AI communicates by text, chat, and social message by default, which matches how ASU-area customers already prefer to reach businesses, rather than expecting them to call during business hours.",
    },
    {
    ...
    },
    {
      ...
      a: "Viking's plans start at $297 a month, flat, with no contracts and no per-seat fees. Compare that to a single front-desk hire in the Tempe market, which runs well over $2,000 a month before benefits, and the AI pays for itself well before the end of the first month for most businesses.",
    },
    {
